...
import com.bambuser.commerce_sdk_demo_app.databinding.ActivityViewSystemLiveBinding
...
class ViewSystemLiveActivity : AppCompatActivity(), PiPDelegate by PiPDelegateActivity() {

    private lateinit var appBarConfiguration: AppBarConfiguration
    private lateinit var binding: ActivityViewSystemLiveBinding
    val tag = "ViewSystemLiveActivity"
    private var eventId: String? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityViewSystemLiveBinding.inflate(layoutInflater)
